...
import id.ac.ub.filkom.sekcv.astech.model.db.core.DatabaseContract;
...
public class MedicalRecord extends DatabaseModel
{
    ...
    public List<id.ac.ub.filkom.sekcv.astech.model.db.entity.MedicalRecord> getDataByUser(int userID)
    {
        ...
        List<id.ac.ub.filkom.sekcv.astech.model.db.entity.MedicalRecord> records = new LinkedList<>();
        if(cursor.moveToFirst())
        {
            do
            {
                records.add(new id.ac.ub.filkom.sekcv.astech.model.db.entity.MedicalRecord(
                        cursor.getInt(0),
                        cursor.getInt(1),
                        cursor.getInt(2),
                        cursor.getDouble(3),
