...
import id.ac.ub.filkom.sekcv.astech.controller.adapter.RecyclerViewAdapter;
...
public class MedicalRecord extends TitledFragment
{
    ...
    private User user;
    private id.ac.ub.filkom.sekcv.astech.model.db.model.MedicalRecord medicalRecordModel;
    ...
    {
        this.medicalRecordModel = new id.ac.ub.filkom.sekcv.astech.model.db.model.MedicalRecord(getContext());
